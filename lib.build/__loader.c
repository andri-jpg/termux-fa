 ...
 */
extern PyObject *modulecode_lib(PyThreadState *tstate, PyObject *, struct Nuitka_MetaPathBasedLoaderEntry const *);

static struct Nuitka_MetaPathBasedLoaderEntry meta_path_loader_entries[] = {
    {"lib", modulecode_lib, 0, 0, NUITKA_TRANSLATED_FLAG
